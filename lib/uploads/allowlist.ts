...
// OOXML formats are ZIPs; distinguishing DOCX vs XLSX vs PPTX would require
// unzipping and inspecting [Content_Types].xml. We disambiguate via declared
// MIME only — magic bytes are identical across all three.
